...
#' If a file is found at the locatioin specified in \code{config_file}, the values will be used.
#'
#' \preformatted{
#' api_token: YOUR_TOKEN_STRING
#' }
#'
#' @param config_file a configuration file in DCF format. See \link{read.dcf}.
